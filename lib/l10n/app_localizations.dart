...
abstract class AppLocalizations {
  ...
  /// No description provided for @personalLoans.
  ///
  /// In en, this message translates to:
  /// **'Personal Loans'**
  String get personalLoans;

  /// No description provided for @businessLoans.
  ///
  /// In en, this message translates to:
  /// **'Business Loans'**
  String get businessLoans;

  /// No description provided for @emergencyLoans.
  ///
  /// In en, this message translates to:
  /// **'Emergency Loans'**
  String get emergencyLoans;
